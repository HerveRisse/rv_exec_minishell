...
/* Vérifie si une commande est une commande builtin du shell */
...
/* Exécute les commandes builtins principales (echo, cd, pwd, export, unset, env, exit) */
...
/* Exécute une commande builtin avec gestion des redirections d'entrée/sortie */
